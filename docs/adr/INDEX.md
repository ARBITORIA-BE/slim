...
| [ADR-0024](0024-neon-vercel-integration.md) | Neon-side Vercel Integration — PR마다 DB branch 자동 생성 (도입 검토) | Proposed (2026-05-15 — Pieter 세션, 옵션 A/B/C 검토 + WebSearch 가격 근거, architect 권고 = 옵션 C 조건부, 채택 결정 운영자 대기) | 2026-05-15 |
...
| [ADR-0029](0029-beta-recruitment.md) | Beta recruitment — channels + honesty + tracking + scope cut | Accepted (2026-05-13 — 운영자 직접 결정, architect 권고). **Amendment 1 (2026-05-14)** — Reddit r/belgium → r/BENL + 한국어 단일 (ADR-0016 SC-E 정합). 카피 4건 `docs/marketing/beta-recruitment-copy.{kr,reddit,salair,tw}.md` 신설 (T2 잠금 4종 + T3 과장 0 검증). | 2026-05-14 |
