...
- [ ] **1.5.6.1** **옵션 X "추정값" UI 표시** (페이즈 4.6 베타 배포 의존성 —
...
| 1.5 | 8 | 6 | 1 | M3 말 (1.5.6 페이즈 5/6 재평가 — ADR-0013 옵션 C; 1.5.6.1 옵션 X 추정값 UI — 4.6 의존성 비차단, architect 2026-05-13 분해) | 2026-05-13 |
...
| **합계** | **84** | **53** | **1** | M0 ~ M24 (≈ 18-24개월) | 2026-05-13 |
