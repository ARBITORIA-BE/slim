...
- [ ] **4.5** 전환 후 7일 이내 후속 메일 (선택 동의) — **ADR-0028** (architect, 2026-05-13 분해)
  ...
  - [x] **4.5.a** ADR-0028 신설 — "Follow-up email — infrastructure (Resend) + data model (`follow_up_email` table) + consent flow + GDPR retention". scribe 가 본문 작성. DoD: ADR-0028 Accepted + INDEX 등재 + ADR-0026 §T1 cross-ref 1줄 + ADR-0008 §cron 흐름 추가 cross-ref. **완료** (2026-05-13, 커밋 [pending]).
